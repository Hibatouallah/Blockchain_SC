...
class Ajoutersollicitation_organisation extends Component {
    state = {
        web3: null,
        accounts: null,
        chainid: null,
    ...
    ajoutersollicitation = async (e) => {
        ...
        var result = await beneficiaire1.methods.ajouterSollicitation('activer',_montant,_cin,accounts[0],_titre,_description,_image1,_image2,_image3,_image4).send({from: accounts[0]})
...
export default Ajoutersollicitation_organisation
