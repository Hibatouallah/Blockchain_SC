...
class Inscriptionbeneficiaire extends Component {
    ...
    Inscriptionbeneficiaire = async (e) => {
        ...
        var nbbeneficiaire = await organisation.methods.getnbBeneficiaireinfos().call()
        if(nbbeneficiaire == 0){
          var result = await organisation.methods.Inscriptionbeneficiaire(_dt,_photo,_cin,_nom,accounts[0],_prenom,_email,_password,_tel, _addresse).send({from: accounts[0]})
          var _message = "Veuillez activer le compte du benficiaire avec le cin "+_cin
          ...
          for(var i = 0;i<nbbeneficiaire;i++){
            var wallet = await organisation.methods.getaccount(i).call()
    ...
    render() {
        ...
        return (<div className="container">
              ...
              <div className="slContainer">
                  <div className ="formBoxLeftSignupbenef"></div>
